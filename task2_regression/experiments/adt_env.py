"""experiment for the ADT Network."""
import glob
import json
import logging
import os
...
from task2_regression.models.adt_env import ADT, pearson_loss, pearson_metric, pearson_tf_non_averaged
...
if __name__ == "__main__":
   ...
   # Get the path to the config gile
    ...
    results_folder = os.path.join(experiments_folder, "results_adt_env_best")
