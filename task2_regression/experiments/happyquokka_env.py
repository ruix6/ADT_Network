...
from task2_regression.models.happyquokka import happyquokka, pearson_loss, pearson_metric, pearson_tf_non_averaged
...
if __name__ == "__main__":
   ...
   # Get the path to the config gile
    ...
    results_folder = os.path.join(experiments_folder, "results_happyquokka_env")
    os.makedirs(results_folder, exist_ok=True)

    # create the model
    model = happyquokka(num_layers=4, embed_dim=64, num_heads=2, d_hid=256)
