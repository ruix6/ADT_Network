...
if __name__ == "__main__":
    ...
    results_folder = os.path.join(experiments_folder, "results_linear_env")
    ...
    model = simple_linear_model(integration_window = int(fs*0.5), nb_filters=1)
    model.summary()
    ...
    for sub in subjects:
        ...
        datasets_test[sub] = create_tf_dataset(test_generator, window_length, None, hop_length, batch_size=1, data_types=(tf.float32, tf.float32), feature_dims=(64, 1))
